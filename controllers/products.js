...
const ProductTag = require('./../config/db').ProductTag;
const Tag = require('./../config/db').Tag;
const ProductImage = require('./../config/db').ProductImage;
...
const ProductRequestDto = require('../dtos/requests/products');
const ProductResponseDto = require('../dtos/responses/products');
